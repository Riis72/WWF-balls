...
from countryballs.spawn import cooldown, chance
...
class Info(commands.Cog):
    ...
    async def about(self, interaction: discord.Interaction):
        ...
        embed.description = (
            ...
            f"**{balls_count:,}** {settings.collectible_name}a kerättävänä\n"
            f"**{players_count:,}** pelaajaa ovat keränneet "
            f"**{balls_instances_count:,}** {settings.collectible_name}a\n"
            f"**{len(self.bot.guilds):,}** serveriä\n\n"
